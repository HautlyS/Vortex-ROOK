    ...
    >
      ...
      >
        <div class="glass-panel-strong rounded-3xl md:rounded-[2rem] p-8 md:p-12 text-center max-w-md w-full border border-violet-400/10 shadow-[0_0_60px_rgba(167,139,250,0.1)]">
          <div class="w-20 h-20 md:w-24 md:h-24 mx-auto mb-6 md:mb-8 rounded-2xl md:rounded-3xl bg-gradient-to-br from-violet-400/25 via-fuchsia-400/20 to-pink-400/15 flex items-center justify-center border border-violet-400/20 shadow-[0_0_40px_rgba(167,139,250,0.2)]">
            <svg
              class="h-10 w-10 md:h-12 md:w-12 text-violet-300"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <h2 class="text-xl md:text-2xl font-black text-white mb-3">
            No Document Yet ✨
          </h2>
          <p class="text-white/50 text-sm md:text-base mb-6 md:mb-8 font-medium">
            Import a PDF or DOCX file to start editing layers
          </p>
          <div
            v-if="!props.isMobile"
            class="flex flex-col gap-3 text-sm text-white/40"
          >
      ...
      >
        ...
        >
          ...
          <!-- Book Spine -->
          <div
            class="w-2 h-full bg-gradient-to-r from-gray-300 via-gray-200 to-gray-300 shadow-inner" 
      ...
      >
        <div class="font-medium text-white/80 mb-2">
          Canvas Controls
        </div>
        <div class="space-y-1">
