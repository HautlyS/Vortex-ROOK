...
<template>
  <div>
    ...
    >
      <div v-if="showPanel" class="absolute top-full left-0 mt-2 w-80 glass-panel-strong rounded-2xl p-4 z-50 overflow-hidden">
        <h4 class="text-sm font-medium text-white/70 mb-4">Advanced Typography</h4>
